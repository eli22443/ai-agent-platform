...
Phases 1–9 are complete. **Deploy track 14a is live on AWS** (`eu-north-1`): ECS API + worker (public subnets, no NAT), ALB, ElastiCache, Secrets Manager, dedicated VPC. Runbook: [infrastructure/aws/README.md](infrastructure/aws/README.md). Guide: [docs/deploy-track.md](docs/deploy-track.md).
